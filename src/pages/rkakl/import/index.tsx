    ...
    <Grid container spacing={6}>
      ...
      <Grid item xs={12}>
        <Card>
          <CardContent>
            <form>
              {importResponse?.data.document.id ? (
                <Box
                  sx={{
                    display: 'flex',
                    flexWrap: 'wrap',
                ...
                >
                  ...
                  <Box>
                    <Button
                      ...
                      variant='contained'
                      color='warning'
                      onClick={() => router.push('/rkakl/import')}
                    >
                      Batal
                    </Button>
                    <Button type='submit' variant='contained' sx={{ ml: 5 }} color='info' onClick={handleActivateFile}>
                      Simpan
                    </Button>
                  </Box>
                </Box>
                ...
                >
                  <Box>
                    {excelFile ? (
                      <Box>
                        ...
                        <Alert variant='outlined' severity='info' sx={{ mt: 5 }}>
                          {fileName}
                        </Alert>
                      </Box>
                    ) : (
                  ...
                  <Button type='submit' variant='outlined' onClick={handleImportSubmit}>
                    Unggah
                  </Button>
                </Box>
              )}
